...
5. **`v1.2.0-beta2`** (2026-04-25) — app-observability Scope B
   ...
   NodeContext labels). PerspectivePollerd Phase 3 was deferred at
   beta2; it shipped later (post-rc2.2) — see the Track 4 subsection.
...
followed post-rc2.2 — implemented by overriding the public
`persistResponseTimeData` callback (the beta2 "no public seam" reading
did not hold), see the Track 4 subsection. Beta2 also surfaced a
compose-orchestration oversight in
